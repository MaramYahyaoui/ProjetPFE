    ...
    return (
        <ScrollView style={{ paddingHorizontal: 25, paddingVertical: 50 }} >
                ...
                >
                    ...
                    <Input InputLeftElement={<Entypo name="key" size={24} color={Colors.green} />}
                    ...
                    <Input InputLeftElement={<Entypo name="key" size={24} color={Colors.green} />}
                        type='password' placeholder='mot de passe'
                    />
                    <Button title="Se connecter" style={{borderRadius: 20, fontWeight: 'bold',}}  color={Colors.dark} >

                    </Button>
                    <Text style={styles.txt1}> ou s'inscrire avec </Text>
